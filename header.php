...
<!-- Header -->
<header class="bg-[#445D84] w-full py-4">
  <div class="container mx-auto px-4">
    <div class="flex justify-between items-center text-white">
     ...
     <img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.svg" alt="" class='w-52'>
      ...
      <nav class="hidden lg:flex items-center space-x-6">
        <a href="/Doctors" class="hover:text-blue-400">Doctors</a>
        <a href="/LASIK-Eye-Surgery" class="hover:text-blue-400">LASIK Eye Surgery</a>
        ...
        <div class="bg-[#65BD9C] py-2 px-4 rounded-sm">
          <a href="tel:954-484-0700" class='flex gap-2 items-center'>
          <i class="fa-solid fa-phone-volume text-white text-xl"></i>
          <p class='text-[18px] md:text-[20px] text-white'>954-484-0700</p>
        </a>
        </div>
      </nav>
