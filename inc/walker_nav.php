...
class Tailwind_Hover_Nav_Walker extends Walker_Nav_Menu {
    public function start_lvl( &$output, $depth = 0, $args = null ) {
        ...
        $output .= '<ul class="md:absolute md:bg-primary left-0 mt-9  w-52 md:px-4 py-2 md:shadow-lg hidden group-hover:block invisible group-hover:visible transition-all duration-200 z-50">';
